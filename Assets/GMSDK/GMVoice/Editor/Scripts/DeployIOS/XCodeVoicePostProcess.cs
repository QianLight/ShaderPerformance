...
public static class XCodeVoicePostProcess
{
	...
	public static void OnPostProcessBuild_CF( BuildTarget target, string pathToBuiltProject )
	{
		...
		DeployIOSVoice.Deploy(pathToBuiltProject);

		string projmodFilePath = GMVoiceEnv.Instance.PATH_VOICE_EDITOR + "/Resources/GMVoiceXcodeConfig.gsdkprojmods";
