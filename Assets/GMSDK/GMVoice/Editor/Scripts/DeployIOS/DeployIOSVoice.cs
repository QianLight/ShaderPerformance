...
public class DeployIOSVoice
{
	static GMVoiceEnv env = GMVoiceEnv.Instance;
    ...
    private static void CopyFrameworks(string pathToBuiltProject)
    {
		...
		GMSDKUtil.CopyDir(env.PATH_VOICE_LIBRARYS_IOS + "/Library/GMSDK", destDir, true);
    }
    ...
    {
		GMSDKUtil.ReplaceTextStringWithRegex(env.PATH_VOICE_EDITOR + "/Resources/GMVoiceXcodeConfig.gsdkprojmods", ".*/GMSDK/", "        \"" + pathToBuiltProject + "/GMSDK/");
    }
