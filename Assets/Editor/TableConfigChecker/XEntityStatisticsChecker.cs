...
namespace TDTools
{
    internal class XEntityStatisticsChecker : BaseChecker
    {
        public void PassMethords()     //希望一来就存在的没有没有必要调函数
        {
            ...
            bool exist_2 = false;
            bool exist_3 = false;
            MethordInfo AimMethord_1 = new MethordInfo("XEntityStatistics", "EmptyCheck", "筛选列内空行", 1, EmptyCheck);
            MethordInfo AimMethord_2 = new MethordInfo("XEntityStatistics", "RepeatedCheck", "筛选列内重复行", 1, RepeatedCheck);
            MethordInfo AimMethord_3 = new MethordInfo("XEntityStatistics", "ForeignkeyCheck", "筛选没有在目标列中出现的内容", 1, ForeignkeyCheck);
