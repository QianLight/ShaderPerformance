...
";
	...
	<real>" + value + "</real>";
        ...
        protected void AdaptHomeIndicator(string pathToBuiltProject)
        {
            XClass UnityAppController = new XClass(pathToBuiltProject + "/Classes/UI/UnityViewControllerBase+iOS.mm");
            UnityAppController.Replace("return UnityGetHideHomeButton();", "return YES;");

            UnityAppController.Replace("return res;", "return UIRectEdgeAll;");
        }

        protected void AddUnityFrameWork(string pathToBuiltProject)
        {
            XClass UnityAppController = new XClass(pathToBuiltProject + "/MainApp/main.mm");
            UnityAppController.Replace("#include <UnityFramework/UnityFramework.h>", @"#include ""../UnityFramework/UnityFramework.h""");
        }
        

        protected void AddExtCode_HandleURL_Extend(string pathToBuiltProject)
        {
            XClass UnityAppController = new XClass(pathToBuiltProject + "/Classes/UnityAppController.mm");
    ...
    @"
        ...
        // 3D Touch相关
        protected void AddExtCode_UIView(string path2BuildProject)
        {
        ...
        protected void AddExtCode_supportOrientation(string path2BuildProject)
        {
