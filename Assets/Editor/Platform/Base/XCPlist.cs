...
namespace UnityEditor.XBuild
{
    ...
    public partial class XCPlist : System.IDisposable
    {
        ...
        */
        ...
        private void processUrlTypes(ArrayList urltypes, IDictionary<string, object> dict)
        {
        ...
        private Dictionary<string, object> findUrlTypeByName(ICollection bundleUrlTypes, string name)
        {
