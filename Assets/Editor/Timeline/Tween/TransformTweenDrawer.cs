...
public class TransformTweenDrawer : PropertyDrawer
{
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        return (fieldCount + 2) * (EditorGUIUtility.singleLineHeight);
    }
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        SerializedProperty ignorePause = property.FindPropertyRelative("ignorePause");
        ...
        singleFieldRect.y += EditorGUIUtility.singleLineHeight;
        EditorGUI.PropertyField(singleFieldRect, ignorePause);
