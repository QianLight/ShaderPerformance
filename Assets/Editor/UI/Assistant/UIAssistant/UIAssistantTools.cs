...
{
    public static Color[] m_colors = new Color[6] {Color.white, Color.yellow, Color.cyan, Color.green, Color.black, Color.red };
    ...
    public static bool ShowSceneBox = false;
        ...
        if (node.IsRoot) 
        {
            ...
            for(int i = 0; i < infos.Count; ++i) 
            {
                if (infos[i].Value.Use) 
                {
                    ...
                    rectInfo.MaterialInstanceName = infos[i].Value.MaterialInstanceName;
