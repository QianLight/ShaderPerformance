...
{
    public class ContinueNode : EventTriggerNode<XContinueData>
    {
        ...
        public override bool CompileCheck()
        {
            ...
            {
                LogError("ContinueNode_" + HosterData.Index + " 只能出现在LoopBody内!!!");
                return false;
            }

            if (loopSet.Count > 1)
            {
                LogError("ContinueNode_" + HosterData.Index + " 不能出现在多个Loop内!!!");
                return false;
            }
