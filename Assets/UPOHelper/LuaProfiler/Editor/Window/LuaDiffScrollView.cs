...
namespace UPOLuaProfiler
{
    ...
    public class LuaDiffScrollView
    {
        ...
        public void DoRefScroll()
        {
            ...
            scrollPositionAdd =
                GUILayout.BeginScrollView(scrollPositionAdd, EditorStyles.helpBox, GUILayout.Height(100));
            int drawCount = 0;
            ...
            scrollPositionNull =
                GUILayout.BeginScrollView(scrollPositionNull, EditorStyles.helpBox, GUILayout.Height(100));
            drawCount = 0;
            ...
            scrollPositionDetail =
                GUILayout.BeginScrollView(scrollPositionDetail, EditorStyles.helpBox, GUILayout.Width(250));
        ...
        public void ShowLog(string fileName, Dictionary<LuaTypes, HashSet<string>> refDict,
            Dictionary<string, List<string>> detailDict)
        {
            ...
            System.Diagnostics.Process.Start("explorer.exe",
                Application.dataPath.Replace("Assets", "Diff").Replace("/", "\\"));
        }
