...
namespace GameRTC
{
	...
	public delegate void GameRTClogOutpoutDelegate(object msg);

	public class GameRTCLog
	{
		public static LogLevel Level = LogLevel.Info;

		private static string prefix = "[GameRTC]:";

		public static GameRTClogOutpoutDelegate OutputDelegate;
