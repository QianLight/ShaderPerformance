...
namespace XLua.CSObjectWrap
{
    ...
    public class CFUtilPoolLibSeqListRef_1_SystemSingle_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CFUtilPoolLib.SeqListRef<float>);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					CFUtilPoolLib.SeqListRef<float> gen_ret = new CFUtilPoolLib.SeqListRef<float>(_d);
				...
				{
				    translator.Push(L, default(CFUtilPoolLib.SeqListRef<float>));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CFUtilPoolLib.SeqListRef<float> constructor!");
        ...
        static int _m_GetValue(RealStatePtr L)
        {
		    try {
                ...
                CFUtilPoolLib.SeqListRef<float> gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                ...
                
                {
                    ...
                    int _key = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        float gen_ret = gen_to_be_invoked.GetValue( _index, _key );
        ...
        static int _m_ContainKey(RealStatePtr L)
        {
		    try {
                ...
                {
                    float _key = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _g_get_parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, CFUtilPoolLib.SeqListRef<float>.parser);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    CFUtilPoolLib.SeqListRef<float>.parser = (CFUtilPoolLib.CVSReader.ValueParse<float>)translator.GetObject(L, 1, typeof(CFUtilPoolLib.CVSReader.ValueParse<float>));
