...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCFUICFLayoutRebuilderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.CFUI.CFLayoutRebuilder);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.CFUI.CFLayoutRebuilder gen_ret = new UnityEngine.CFUI.CFLayoutRebuilder();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.CFUI.CFLayoutRebuilder constructor!");
        ...
        static int _m_IsDestroyed(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.CFUI.CFLayoutRebuilder gen_to_be_invoked = (UnityEngine.CFUI.CFLayoutRebuilder)translator.FastGetCSObj(L, 1);
        ...
        static int _m_ForceRebuildLayoutImmediate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.RectTransform _layoutRoot = (UnityEngine.RectTransform)translator.GetObject(L, 1, typeof(UnityEngine.RectTransform));
                    
                    UnityEngine.CFUI.CFLayoutRebuilder.ForceRebuildLayoutImmediate( _layoutRoot );
        ...
        static int _m_MarkLayoutForRebuild_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.CFUI.CFLayoutRebuilder.MarkLayoutForRebuild( _rect );
