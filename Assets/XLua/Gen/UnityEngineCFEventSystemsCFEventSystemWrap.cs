...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCFEventSystemsCFEventSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.CFEventSystems.CFEventSystem);
        ...
        {
            return LuaAPI.luaL_error(L, "UnityEngine.CFEventSystems.CFEventSystem does not have a constructor!");
        }
        ...
        static int _m_UpdateModules(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.CFEventSystems.CFEventSystem gen_to_be_invoked = (UnityEngine.CFEventSystems.CFEventSystem)translator.FastGetCSObj(L, 1);
        ...
        static int _m_SetSelectedGameObject(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.GameObject>(L, 2)&& translator.Assignable<UnityEngine.CFEventSystems.BaseEventData>(L, 3)) 
                {
                    UnityEngine.GameObject _selected = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
                    UnityEngine.CFEventSystems.BaseEventData _pointer = (UnityEngine.CFEventSystems.BaseEventData)translator.GetObject(L, 3, typeof(UnityEngine.CFEventSystems.BaseEventData));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.CFEventSystems.CFEventSystem.SetSelectedGameObject!");
        ...
        static int _m_RaycastAll(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    System.Collections.Generic.List<UnityEngine.CFEventSystems.RaycastResult> _raycastResults = (System.Collections.Generic.List<UnityEngine.CFEventSystems.RaycastResult>)translator.GetObject(L, 3, typeof(System.Collections.Generic.List<UnityEngine.CFEventSystems.RaycastResult>));
        ...
        static int _m_IsPointerOverGameObject(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.CFEventSystems.CFEventSystem.IsPointerOverGameObject!");
        ...
        static int _g_get_current(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.CFEventSystems.CFEventSystem.current);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_current(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    UnityEngine.CFEventSystems.CFEventSystem.current = (UnityEngine.CFEventSystems.CFEventSystem)translator.GetObject(L, 1, typeof(UnityEngine.CFEventSystems.CFEventSystem));
