...
namespace XLua.CSObjectWrap
{
    ...
    public class CFUtilPoolLibSeqRef_1_SystemSingle_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CFUtilPoolLib.SeqRef<float>);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					CFUtilPoolLib.SeqRef<float> gen_ret = new CFUtilPoolLib.SeqRef<float>(_d);
				...
				{
				    translator.Push(L, default(CFUtilPoolLib.SeqRef<float>));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CFUtilPoolLib.SeqRef<float> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<CFUtilPoolLib.SeqRef<float>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					CFUtilPoolLib.SeqRef<float> gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
		    ...
		    try {
                ...
                
                {
                    int _key = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        float gen_ret = gen_to_be_invoked.GetValue( _key );
        ...
        static int _g_get_parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, CFUtilPoolLib.SeqRef<float>.parser);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    CFUtilPoolLib.SeqRef<float>.parser = (CFUtilPoolLib.CVSReader.ValueParse<float>)translator.GetObject(L, 1, typeof(CFUtilPoolLib.CVSReader.ValueParse<float>));
        ...
        static int _s_set_bufferRef(RealStatePtr L)
        {
		    try {
                ...
                CFUtilPoolLib.SeqRef<float> gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.bufferRef = (float[])translator.GetObject(L, 2, typeof(float[]));
