    ...
    public class LuaEnv : IDisposable
    {
        ...
        public LuaEnv()
        {
            ...
            lock(luaEnvLock)
            {
                ...
                AddBuildin("pb", StaticLuaCallbacks.LoadLuaProfobuf);
        ...
        public int LoadLuaTable(string search, string table, string patch)
        {
            return LuaAPI.luaE_table(L, search, table, patch, 1);
        }
