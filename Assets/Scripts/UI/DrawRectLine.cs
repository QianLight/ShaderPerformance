...
public class DrawRectInfo : IComparable<DrawRectInfo>
{
    ...
    public int Depth
    {
        ...
        private string m_materialInstanceName = string.Empty;

    public string MaterialInstanceName{
        set{m_materialInstanceName = value;}
        get{
            return m_materialInstanceName;
        }
    }
...
public class DrawRectLine : MonoBehaviour {
    private Color[] m_colors = new Color[6] { Color.white, Color.yellow, Color.blue, Color.green, Color.black, Color.red};
