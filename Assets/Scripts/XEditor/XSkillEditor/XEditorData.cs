...
namespace XEditor
{
    ...
    public class XFashionLibrary
    {
        ...
        //            {
        //                FashionUtil.DrawSuit(go, _suit.Table[i], presentid);
        //                break;
        //            }
        //        }
        //    }
    ...
    public class XDestructionLibrary
    {
        ...
        //            if (mesh != null) renders[i].SetSharedMesh(mesh);
    ...
    public class XReactLibrary
    {
        public static XPresentConfig PresentConfig { get; } = new XPresentConfig();
        static XReactLibrary()
        {
            PresentConfigTable table = new PresentConfigTable();
            XTableReader.ReadFile(@"Table/PresentConfigTable", table);
            PresentConfig.Init(table);
        }
    }
    ...
    public class XEditorData
    {
        ...
        [SerializeField]
        public bool XCollimationFx_foldout;
        [SerializeField]
        public bool XCameraLayerMask_foldout;
        [SerializeField]
        ...
        public void ToggleFold<T>(bool b) where T : XBaseData
        {
            ...
            if (t == typeof(XFxData)) XFx_foldout = b;
