...
namespace XEditor
{
    ...
    public static class FashionUtil
    {
        ...
        //public static void DrawSuit(GameObject go, FashionSuit.RowData rowData, uint presentid)
        //{
        //    if (rowData != null)
        //    {
        ...
        //            DrawWeapon(go, (RoleShape)rowData.shape, rowData.dir, part, presentid, SearchPart(rowData.id, (uint)FPart.WEAPON));
        //        }
        //    }
        //    else
        //    {
        ...
        //public static void DrawWeapon(GameObject go, RoleShape shape, string dir, XRolePart part, uint presentid,  FashionList.RowData row)
        //{
        ...
        //    string cname = "Player_" + sshape + "_" + dir + "_" + TCConst.WEAPON + "_" + presentid;
        ...
        //        if (mesh != null) smr.SetSharedMesh(mesh);
