...
namespace UnityEngine.Timeline
{
    ...
    [TrackClipType(typeof(CameraTransitionAsset))]
    [ExcludeFromPreset]
#if UNITY_EDITOR
    [CSDiscriptor("镜头叠化")]
#endif
    public class CameraTransitionTrack : TrackAsset
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            return RTimeline.TrackType_CameraEffect;
        }
        ...
        List<string> ITimelineAsset.ReferenceAssets(PlayableBinding pb)
        {
            ...
            var tack = pb.sourceObject as CameraTransitionTrack;
        ...
        public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
        {
            ...
            {
                CameraTransitionAsset asset = (CameraTransitionAsset)(c.asset);
