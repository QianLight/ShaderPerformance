...
namespace UnityEngine.Timeline
{
    ...
    [TrackClipType(typeof(CustomPictureAsset))]
    [ExcludeFromPreset]
#if UNITY_EDITOR
    [CSDiscriptor("自定义图片")]
#endif
    public class CustomPictureTrack : TrackAsset
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            return RTimeline.TrackType_CustomPicture;
        }
        ...
        public void GUIDisplayName()
        {
            ...
            foreach (var clip in clips)
            {
                if (clip.asset != null)
                {
                    CustomPictureAsset asset = clip.asset as CustomPictureAsset;
        ...
        public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
        {
            ...
            {
                CustomPictureAsset asset = (CustomPictureAsset)(c.asset);
