...
namespace UnityEditor.Recorder
{
    ...
    class RecorderSettingsPrefsEditor : Editor
    {
        ...
        static class Styles
        {
            ...
            internal static readonly GUIContent AudioDevicesLabel = new GUIContent("Audio Devices", "Select audio device!");
        ...
        internal bool RecordModeGUI()
        {
            ...
            if (CFAudioRecorder.GetAllDevices != null)
            {
                CFAudioRecorder.AudioDeviceIndex = EditorGUILayout.Popup(Styles.AudioDevicesLabel,
                    CFAudioRecorder.AudioDeviceIndex, CFAudioRecorder.GetAllDevices);
