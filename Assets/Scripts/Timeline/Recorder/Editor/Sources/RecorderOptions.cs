...
namespace UnityEditor.Recorder
{
    ...
    {
        internal const string k_VerboseModeMenuItem = RecorderWindow.MenuRoot + "Options/Verbose Mode";
        internal const string k_ShowRecorderGameObject = RecorderWindow.MenuRoot + "Options/Show Recorder GameObject";

        internal const string k_ExitPayModeItem = RecorderWindow.MenuRoot + "Options/Exit PlayMode";
        internal const string k_RecorderPanelWidth = RecorderWindow.MenuRoot + "Options/Recorder Panel Width";
        internal const string k_SelectedRecorderIndex = RecorderWindow.MenuRoot + "Options/Selected Recorder Index";
