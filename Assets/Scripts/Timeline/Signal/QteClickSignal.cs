...
[CSDiscriptor("QTE","QTE")]
#endif
public class QteClickSignal : DirectorSignalEmmiter
{
    public bool m_enable = true;                //是否开启
    public string m_prefabName = string.Empty;  //使用的prefab
    public Vector2 m_position;                  //UI的位置
    public QTEType m_qteType;                   //QTE的类型
    public bool m_isLoop;                       //单击QTE，是否循环
    ...
    public string m_succeedEvent;               //成功音效
    public string m_failEvent;                  //失败音效
