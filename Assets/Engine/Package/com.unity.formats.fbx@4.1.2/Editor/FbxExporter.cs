    ...
    public sealed class ModelExporter : System.IDisposable
    {
        ...
        internal bool ExportMaterial (Material unityMaterial, FbxScene fbxScene, FbxNode fbxNode)
        {
			...
			if(unityMaterial.HasProperty("_Color"))
				fbxMaterial.Diffuse.Set (GetMaterialColor (unityMaterial, "_Color"));
			else if(unityMaterial.HasProperty("_BaseColor"))
				fbxMaterial.Diffuse.Set (GetMaterialColor (unityMaterial, "_BaseColor"));
			//fbxMaterial.Diffuse.Set (new FbxDouble3 (1,0,0));
           ...
           // }
            ...
            if(unityMaterial.HasProperty("_MainTex"))
				ExportTexture (unityMaterial, "_MainTex", fbxMaterial, FbxSurfaceMaterial.sDiffuse);
			else if(unityMaterial.HasProperty("_BaseMap"))
				ExportTexture (unityMaterial, "_BaseMap", fbxMaterial, FbxSurfaceMaterial.sDiffuse);
			//TODO 
