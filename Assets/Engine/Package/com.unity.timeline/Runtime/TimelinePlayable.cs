...
namespace UnityEngine.Timeline
{
    ...
    public class TimelinePlayable : PlayableBehaviour
    {
        ...
        public static ScriptPlayable<TimelinePlayable> Create (
            PlayableGraph graph, TimelineAsset ta,
            IEnumerable<TrackAsset> tracks, GameObject go, bool autoRebalance, bool createOutputs)
        {
            ...
            sequence.Compile (graph, playable, ta, tracks, go, autoRebalance, createOutputs);
        ...
        /// <param name="autoRebalance">In the editor, whether the graph should account for the possibility of changing clip times</param>
        /// <param name="createOutputs">Whether to create PlayableOutputs in the graph</param>
        public void Compile (PlayableGraph graph, Playable timelinePlayable, TimelineAsset ta,
            IEnumerable<TrackAsset> tracks, GameObject go, bool autoRebalance, bool createOutputs)
        {
            asset = ta;
            if (tracks == null)
            ...
            DirectorHelper.singleton.recordCount = 0;
        ...
        void CreateTrackOutput (PlayableGraph graph, TrackAsset track, GameObject go, Playable playable, int port)
        {
            ...
            foreach (var binding in bindings)
            {
                ...
                //     INotificationReceiver receiver = go.GetComponent<INotificationReceiver> ();
                //     if (receiver != null)
                //     {
        ...
        private void Evaluate (Playable playable, FrameData frameData)
        {
            ...
            if (asset != null && asset.animEnv == null)
            {
                asset.BindEngineObject();
            }
            if (asset != null && asset.animEnv != null)
            {
                asset.animEnv.Update ((float) localTime);
            }
        }
