...
namespace UnityEditor.Timeline
{
    class TimelineTrackGUI : TimelineGroupGUI, IClipCurveEditorOwner, IRowGUI
    {
            ...
            : base(tv, w, id, depth, parent, displayName, sequenceActor, false)
        {
            ...
            {
                var attr = Attribute.GetCustomAttribute (sequenceActor.GetType (), typeof (CustomInfiniteTrackAttribute)) as CustomInfiniteTrackAttribute;
                if (attr != null)
                {
                    m_InfiniteTrackDrawer = new CustomInfiniteTrackDrawer (sequenceActor);
                }
            }
        ...
        public override float GetHeight (WindowState state)
        {
            ...
            if (m_InfiniteTrackDrawer != null)
            {
                height += m_InfiniteTrackDrawer.GetHeightExt ();
            }
            return height;
        }
