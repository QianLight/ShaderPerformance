...
namespace UnityEditor.Timeline
{
    static class TimelineHelpers
    {
        ...
        public static string GetTrackCategoryName(System.Type trackType)
        {
            ...
            if (trackType.Namespace == null || trackType.Namespace.Contains("UnityEngine")||trackType.Namespace.Contains("CFEngine"))
                return string.Empty;
        ...
        {
            return ObjectNames.NicifyVariableName(trackType.Name) + GetTrackDecriptor(trackType);
        }

        public static string GetTrackDecriptor(System.Type t)
        {
            if (Attribute.GetCustomAttribute(t, typeof(CSDiscriptor)) is CSDiscriptor attr)
            {
