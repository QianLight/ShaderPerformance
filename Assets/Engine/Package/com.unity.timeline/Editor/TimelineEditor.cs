...
namespace UnityEditor.Timeline
{
    ...
    public static class TimelineEditor
    {
        ...
        public static float editorTime { get { return state == null ? 0 : (float)state.editSequence.time; } }
        /// <summary>
        /// <para>
        ...
        public static void Refresh (RefreshReason reason,bool reCalcuteSize = false)
        {
            if (state == null)
                return;
        ...
        public static UnityEngine.Vector2 ToLocalPos(UnityEngine.Vector2 pos)
        {
            return pos - window.position.position;
        }
