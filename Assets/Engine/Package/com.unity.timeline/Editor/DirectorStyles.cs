...
namespace UnityEditor.Timeline
{
    public class DirectorStyles
    {
        ...
        const string k_ImagePath = "Assets/Engine/Package/com.unity.timeline/Editor/StyleSheets/Images/Icons/{0}.png";
        public const string resourcesPath = "Assets/Engine/Package/com.unity.timeline/Editor/StyleSheets/res/";
        ...
        internal static Texture2D GetBackgroundImage(GUIStyle style, StyleState state = StyleState.normal)
        {
