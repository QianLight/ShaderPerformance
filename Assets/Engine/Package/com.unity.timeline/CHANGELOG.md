...
### Backports
- Fixed issue with clip connectors that were incorrectly drawn when the timeline was panned or zoomed. (1156627)
- Fixed issue where evaluating a Playable Graph inside a Notification Receiver would cause an infinite recursion. ([1156624](https://issuetracker.unity3d.com/product/unity/issues/guid/1156624/))
- Fixed Trim and Move operations to ensure playable duration is updated upon completion. ([1156715](https://issuetracker.unity3d.com/product/unity/issues/guid/1156715/))
- Track binding field is now larger. (1155092)
- Fixed issue where an empty Timeline window would create new objects on each repaint. (1154471)
