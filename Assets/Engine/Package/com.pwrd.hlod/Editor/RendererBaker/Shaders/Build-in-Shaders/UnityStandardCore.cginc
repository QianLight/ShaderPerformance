...
VertexOutputForwardBase vertForwardBase (VertexInput v)
{
    ...
    #if _RENDERER_BAKE_
        o.pos = float4((v.uv1 * float2(1, -1) + float2(0, 1) - 0.5) * 2, 0.1, 1);
    #else
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
    ...
    half4 c = UNITY_BRDF_PBS (s.diffColor, s.specColor, s.oneMinusReflectivity, s.smoothness, s.normalWorld, gi.light.dir, gi.light, gi.indirect);
