    ...
    public static class KMeans
    {
        ...
        public static KMeansResults Cluster(double[][] data, int clusterCount, int maxIterations, int seed)
        {
            ...
            while (hasChanges && iteration < maxIterations)
            {
                ...
                totalDistance = CalculateClusteringInformation(data, clustering, ref means, ref centroidIdx,
                    clusterCount, ref clusterItemCount);
            ...
            for (int i = 0; i < clustering.Length; i++)
            {
                ...
                {
                    HLODDebug.LogWarning(e.Message);
                }
            }
        ...
        private static double CalculateClusteringInformation(double[][] data, int[] clustering, ref double[][] means,
            ref int[] centroidIdx, int clusterCount, ref int[] clusterItemCount)
        {
