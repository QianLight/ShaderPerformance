...
namespace UnityEditor.U2D.Sprites
{
    ...
    internal class SpriteEditorWindow : SpriteUtilityWindow, ISpriteEditor
    {
        ...
        private class SpriteEditorWindowStyles
        {
            ...
            public static readonly string styleSheetPath = "Assets/Engine/Package/com.unity.2d.sprite/Editor/UI/SpriteEditor/SpriteEditor.uss";
        }
        ...
        {
            var path = m_SpriteDataProviderFactories.GetAssetPath(Selection.activeObject);
            if (string.IsNullOrEmpty(path))
        ...
        public bool selectedProviderChanged
        {
            get
            {
                ...
                var dataProvider = m_SpriteDataProviderFactories.GetSpriteEditorDataProviderFromObject(Selection.activeObject);
        ...
        private void UpdateSelectedSpriteRectFromSelection()
        {
            ...
            {
                var sprite = m_SpriteDataProviderFactories.GetSpriteObject(Selection.activeObject);
