...
namespace UnityEditor.U2D.Sprites
{
    internal partial class SpritePolygonModeModule : SpriteFrameModuleBase
    {
        ...
        {
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Engine/Package/com.unity.2d.sprite/Editor/UI/SpriteEditor/PolygonChangeShapeWindow.uxml") as VisualTreeAsset;
