...
namespace UnityEditor.U2D.Sprites
{
    ...
    internal class SpriteBoneDataTransfer : SpriteDataProviderBase, ISpriteBoneDataProvider
    {
        ...
        public List<UnityEngine.U2D.SpriteBone> GetBones(GUID guid)
        {
        ...
        public void SetBones(GUID guid, List<UnityEngine.U2D.SpriteBone> bones)
        {
        ...
        public static void Apply(SerializedProperty rectSP, List<UnityEngine.U2D.SpriteBone> spriteBone)
        {
