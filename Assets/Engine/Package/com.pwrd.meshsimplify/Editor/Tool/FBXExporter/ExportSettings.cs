...
namespace UnityEditor.FBX {
    ...
    internal class ExportSettingsEditor : UnityEditor.Editor {
        ...
        private void ShowExportPathUI(string label, string tooltip, string openFolderPanelTitle, bool isSingletonInstance)
        {
        ...
        public override void OnInspectorGUI() {
            ...
            var version = UnityEditor.FBX.ModelExporter.GetVersionFromReadme ();
            ...
            {
                EditorGUI.indentLevel++;
                ShowExportPathUI("Export Path", "Location where the FBX will be saved.", "Select Export Model Path", isSingletonInstance);
            ...
            if (GUILayout.Button (Style.RepairMissingScripts)) {
                var componentUpdater = new UnityEditor.FBX.RepairMissingScripts ();
    ...
    internal class ExportSettings : ScriptableObject
    {
        ...
        internal static string GetProjectRelativePath(string fullPath){
            var assetRelativePath = UnityEditor.FBX.ExportSettings.ConvertToAssetRelativePath(fullPath);
