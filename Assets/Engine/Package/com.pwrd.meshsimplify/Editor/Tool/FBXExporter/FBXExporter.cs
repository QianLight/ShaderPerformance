    ...
    public sealed class ModelExporter : System.IDisposable
    {
        ...
        private bool ExportComponentAttributes (MeshInfo mesh, FbxMesh fbxMesh, int[] unmergedTriangles)
        {
            ...
            if (mesh.HasValidNormals()) {
                using (var fbxLayerElement = FbxLayerElementNormal.Create (fbxMesh, "Normals")) {
                    ...
                    for (int n = 0; n < mesh.Normals.Length; n++) {
                        fbxElementArray.Add (ConvertToFbxVector4 (mesh.Normals [n]));
                    }
            ...
            if (mesh.HasValidBinormals()) {
                using (var fbxLayerElement = FbxLayerElementBinormal.Create (fbxMesh, "Binormals")) {
                    ...
                    for (int n = 0; n < mesh.Binormals.Length; n++) {
                        fbxElementArray.Add (ConvertToFbxVector4 (mesh.Binormals [n]));
                    }
            ...
            if (mesh.HasValidTangents()) {
                using (var fbxLayerElement = FbxLayerElementTangent.Create (fbxMesh, "Tangents")) {
                    ...
                    for (int n = 0; n < mesh.Tangents.Length; n++) {
        ...
        bool ExportMesh (MeshInfo meshInfo, FbxNode fbxNode)
        {
            ...
            ControlPointToIndex.Clear();
            {
                ...
                fbxMesh.InitControlPoints (vertices.Count());
        ...
        public int ExportRendereres (IEnumerable<UnityEngine.Object> unityExportSet, string outPath, Vector3 center)
        {
            ExportModelSettingsSerialize opt = new ExportModelSettingsSerialize();
            opt.SetExportFormat( ExportSettings.ExportFormat.Binary );
            ExportOptions = opt;
            
            exportCancelled = false;
            
            m_lastFilePath = outPath;
        ...
        )
        {
            ...
            {
                exportOptions = DefaultOptions;
                (exportOptions as ExportModelSettingsSerialize).SetExportFormat(ExportSettings.ExportFormat.Binary);
            }
