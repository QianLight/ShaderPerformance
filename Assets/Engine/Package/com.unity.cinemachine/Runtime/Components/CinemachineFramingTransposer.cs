...
namespace Cinemachine
{
    ...
    public class CinemachineFramingTransposer : CinemachineComponentBase
    {
        ...
        {
            get { return m_CameraDistance * _distance_scale; }
            set { m_CameraDistance = value; }
        }

        private float _screen_y_scale = 1f;
        private float _distance_scale = 1f;
        public void SetCustomScale(float screenY, float distance)
        {
            _screen_y_scale = screenY;
            _distance_scale = distance;
        }
        #endregion
        ...
        internal Rect SoftGuideRect
        {
            ...
            {
                return new Rect(
                    ScreenX - m_DeadZoneWidth / 2, ScreenY - m_DeadZoneHeight / 2,
            ...
            set
            {
                ...
                ScreenX = Mathf.Clamp(value.x + m_DeadZoneWidth / 2, -0.5f,  1.5f);
        ...
        internal Rect HardGuideRect
        {
            ...
            {
                Rect r = new Rect(
                        ScreenX - m_SoftZoneWidth / 2, ScreenY - m_SoftZoneHeight / 2,
            ...
            set
            {
                ...
                Vector2 bias = center - new Vector2(ScreenX, ScreenY);
        ...
        {
            CameraDistance = Mathf.Max(m_CameraDistance, kMinimumCameraDistance);
