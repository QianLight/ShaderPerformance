...
namespace Cinemachine
{
    ...
    public class CinemachinePOV : CinemachineComponentBase
    {
        ...
        [AxisStateProperty]
        public AxisState m_VerticalAxis = new AxisState(-70, 70, false, false, 300f, 0.1f, 0.1f, "", true);
        ...
        [AxisStateProperty]
        public AxisState m_HorizontalAxis = new AxisState(-180, 180, true, false, 300f, 0.1f, 0.1f, "", false);
        ...
        public override void MutateCameraState(ref CameraState curState, float deltaTime)
        {
            ...
            if (deltaTime >= 0 && CinemachineCore.Instance.IsLive(VirtualCamera))
            {
                ...
                if (m_HorizontalAxis.m_InputAxisValueValid)
                {
                    m_HorizontalRecentering.CalcalateInputWaitTime();
                }
                if (m_VerticalAxis.m_InputAxisValueValid)
                {
                    m_VerticalRecentering.CalcalateInputWaitTime();
                }
