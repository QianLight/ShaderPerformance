            ...
            if (FollowTarget != null)
            {
                ...
                switch (m_BindingMode)
                {
                    ...
                    case BindingMode.SimpleFollowWithWorldUp:
                    {
                        ...
                        if (fwd.AlmostZero())
                            break;
                            return Quaternion.Lerp(Quaternion.LookRotation(fwd, worldUp), Quaternion.Euler(0, VcamState.RawOrientation.eulerAngles.y, 0), m_FollowParam);
                    }
                }
            }
