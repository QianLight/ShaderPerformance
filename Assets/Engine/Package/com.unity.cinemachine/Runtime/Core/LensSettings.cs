...
namespace Cinemachine
{
    ...
    public struct LensSettings
    {
        ...
        static public bool operator == (LensSettings left, LensSettings right)
        {
            return left.Aspect == right.Aspect &&
                left.IsPhysicalCamera == right.IsPhysicalCamera &&
                left.Orthographic == right.Orthographic &&
                left.SensorSize == right.SensorSize &&
                left.Dutch == right.Dutch &&
                left.FarClipPlane == right.FarClipPlane &&
                left.FieldOfView == right.FieldOfView &&
                left.GateFit == right.GateFit &&
                left.LensShift == right.LensShift &&
                left.ModeOverride == right.ModeOverride &&
                left.m_OrthoFromCamera == right.m_OrthoFromCamera &&
                left.m_PhysicalFromCamera == right.m_PhysicalFromCamera &&
                left.m_SensorSize == right.m_SensorSize &&
                left.NearClipPlane == right.NearClipPlane &&
