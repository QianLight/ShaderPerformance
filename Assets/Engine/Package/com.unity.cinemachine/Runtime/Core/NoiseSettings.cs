...
namespace Cinemachine
{
    ...
    public sealed class NoiseSettings : SignalSourceAsset
    {
        ...
        public struct NoiseParams
        {
            ...
            /// <summary>If checked, then the amplitude and frequency will be Sin</summary>
            [Tooltip("If checked, then the amplitude and frequency will be Sin.")]
            public bool Sin;
            ...
            public float GetValueAt(float time, float timeOffset)
            {
                ...
                if (Constant)
                    return (Sin ? Mathf.Sin(t * 2 * Mathf.PI) : Mathf.Cos(t * 2 * Mathf.PI)) * Amplitude * 0.5f;
