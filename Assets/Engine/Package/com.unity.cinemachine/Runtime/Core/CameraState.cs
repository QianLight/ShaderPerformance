...
namespace Cinemachine
{
    ...
    public struct CameraState
    {
        ...
        static public bool LerpEqual(CameraState left, CameraState right)
        {
            return left.BlendHint == right.BlendHint &&
                left.Lens == right.Lens &&
                left.ReferenceUp == right.ReferenceUp &&
                left.ShotQuality == right.ShotQuality &&
                left.PositionCorrection == right.PositionCorrection &&
                left.OrientationCorrection == right.OrientationCorrection &&
                left.HasLookAt == right.HasLookAt &&
                left.ReferenceLookAt == right.ReferenceLookAt &&
                left.CorrectedPosition == right.CorrectedPosition &&
                left.CorrectedOrientation == right.CorrectedOrientation &&
                left.RawPosition == right.RawPosition &&
                left.RawOrientation == right.RawOrientation &&
                left.NumCustomBlendables == right.NumCustomBlendables;
        }
