...
namespace Cinemachine
{
    ...
    public class CinemachineMixingCamera : CinemachineVirtualCameraBase
    {
        ...
        public float GetWeight(int index)
        {
            ...
            CFUtilPoolLib.XDebug.singleton.AddErrorLog("CinemachineMixingCamera: Invalid index: " + index);
            return 0;
        }
        ...
        public float GetWeight(CinemachineVirtualCameraBase vcam)
        {
            ...
            CFUtilPoolLib.XDebug.singleton.AddErrorLog("CinemachineMixingCamera: Invalid child: "
