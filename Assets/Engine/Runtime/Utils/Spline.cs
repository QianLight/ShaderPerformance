...
namespace CFEngine
{
    ...
    public sealed class Spline
    {
        ...
        public Spline(AnimationCurve curve, float zeroValue, bool loop, Vector2 bounds,string name)
        {
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hash = 17;
                hash = hash * 23 + name.GetHashCode(); // Not implemented in Unity, so it'll always return the same value :(
                return hash;
            }
        }
    }
