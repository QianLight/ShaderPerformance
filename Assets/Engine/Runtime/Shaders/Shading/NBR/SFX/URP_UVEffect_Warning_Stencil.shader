Shader"URP/SFX/Warning_Stencil"
{
    Properties
    {
        ...
        _Brightness("亮度-mul", Float) = 1
        _Contrast("对比度-pow", Float) = 1
        ...
        */
        ...
        /*
        //[Header(自定义溶解)]
        //_Hardness("Hardness-硬度", Range(0, 0.99)) = 0
        //_Dissolve("Dissolve-溶解", Float) = 0    
        //[HDR]_WidthColor("Width Color-宽度颜色", Color) = (1, 1, 1, 1)
        //_EdgeWidth("EdgeWidth-边宽度", Range(0,1)) = 0
        */
...
*/
                ...
                half3 color = pow(main.xyz, _Contrast) * _Brightness * lerp(lerp(_MainColor.xyz, _BackColor.xyz, _UseBackColor), _MainColor, max(vface, 0)) * i.color.xyz;
...
/*
            ...
            #endif
*/
                main.a = min(i.color.a * _MainColor.a * lerp(main.a, main.r, _AlphaR) * clipXY.y * _Alpha * fresnel * mask,1);
/*
            #ifdef _DEPTHMODE_ON
                clip(main.a - _CUTOUT);
            #endif
