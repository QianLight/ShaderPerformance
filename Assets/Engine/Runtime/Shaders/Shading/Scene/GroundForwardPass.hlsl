#ifndef GROUND_FORWARD_PASS_INCLUDED
#define GROUND_FORWARD_PASS_INCLUDED
...
half4 LitPassFragment(Varyings input) : SV_Target
{
    ...
    * Feature: Give Model a vertical gradient color */
        ...
        //half4 pbrColor;
        VerticalColor(origion_color,input.positionWSColor,_GradientEnd,_GradientBegin,_WorldPositionOffset,
                    _WorldPositionScale,_GradientSwitch,_BlendMode,
