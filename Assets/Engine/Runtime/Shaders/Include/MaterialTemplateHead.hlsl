...
// #define _Emi_Tex _ProcedureTex1
...
FLOAT3 Emissive0(FLOAT2 uv,FLOAT3 Emissive,FLOAT4 Param,FLOAT4 Color)
{
	...
	return Emissive.xyz *_Emi_Color.xyz*(1+noise*20)*_Emi_Intensity;
}
...
inline void CalcEmissive(in FFragData FragData,inout FMaterialData MaterialData)
{
	...
	if(_Emi_Effect)
	{
		...
		FLOAT3 Emissive = MaterialData.BaseColor.xyz*mask * lerp(_SceneColor.rgb, 1, _SceneColor.a);
