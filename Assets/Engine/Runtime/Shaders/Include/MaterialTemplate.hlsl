...
#ifdef _DEPTH_SHADOW
    FragData.CLIPSVPOSTION = Interpolants.CLIPPostion;
	FragData.ClipScreenPosition=FLOAT4(Interpolants.CLIPScreenPosition.xy/Interpolants.CLIPScreenPositionW.x,Interpolants.CLIPScreenPosition.zw/Interpolants.CLIPScreenPositionW.y);
#endif
