...
namespace CFEngine
{
    public class EnviromentSHBakerHelper : CFSingleton<EnviromentSHBakerHelper>
    {
        ...
        private const string m_AmbientProbeConvolution = "AmbientProbeConvolution";
        public void Init(ComputeShader shBaker)
        {
            ...
            {
                if (m_ComputeAmbientProbeCS.HasKernel(m_AmbientProbeConvolution))
                    m_ComputeAmbientProbeKernel = m_ComputeAmbientProbeCS.FindKernel(m_AmbientProbeConvolution);
            }
        }
