...
namespace CFEngine.ShaderVariantsStripper
{
    public class ShaderVariantsStripperWindow : EditorWindow
    {
        ...
        private static MethodInfo m_sGetShaderGlobalKeywordsMethod;

        private static MethodInfo sGetShaderGlobalKeywordsMethod
        {
            get
            {
                if (m_sGetShaderGlobalKeywordsMethod == null)
                {
                    InitKeywordsMethod();
                }

                return m_sGetShaderGlobalKeywordsMethod;
            }
        }
        ...
        [MenuItem("Tools/引擎/Shader变体组合剔除-Window", priority = 200)]
        public static void OpenWindow()
        {
            Window.Show();
        }

        private static void InitKeywordsMethod()
        {
            if (m_sGetShaderGlobalKeywordsMethod == null)
                m_sGetShaderGlobalKeywordsMethod = typeof(ShaderUtil).GetMethod("GetShaderGlobalKeywords",
             ...
             else// mConfig == null
            {
                ...
                if (mCurrentContentState == ContentState.StripCheck)
                {
                    ...
                    if (nextStripCheckShader != mStripCheckShader)
                    {
                        ...
                        {
                            Debug.Log("sGetShaderGlobalKeywordsMethod:"+sGetShaderGlobalKeywordsMethod+"  nextStripCheckShader:"+nextStripCheckShader);
