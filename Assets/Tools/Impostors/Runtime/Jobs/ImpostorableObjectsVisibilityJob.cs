...
namespace Impostors.Jobs
{
    ...
    public struct ImpostorableObjectsVisibilityJob : IJobParallelFor
    {
        ...
        public void Execute(int index)
        {
            ...
            if (isVisible)
            {
                switch (impostorableObject.visibleState)
                {
                    case ImpostorableObject.VisibilityState.NotSet:
                    case ImpostorableObject.VisibilityState.BecameInvisible:
                    case ImpostorableObject.VisibilityState.Invisible:
                        impostorableObject.visibleState = ImpostorableObject.VisibilityState.BecameVisible;
                        break;
                    case ImpostorableObject.VisibilityState.BecameVisible:
                    case ImpostorableObject.VisibilityState.Visible:
                        impostorableObject.visibleState = ImpostorableObject.VisibilityState.Visible;
                        break;
                    default:
            ...
            else
            {
                switch (impostorableObject.visibleState)
                {
                    ...
                    case ImpostorableObject.VisibilityState.BecameVisible:
                    case ImpostorableObject.VisibilityState.Visible:
                        impostorableObject.visibleState = ImpostorableObject.VisibilityState.BecameInvisible;
                        break;
                    case ImpostorableObject.VisibilityState.BecameInvisible:
                    case ImpostorableObject.VisibilityState.Invisible:
                        impostorableObject.visibleState = ImpostorableObject.VisibilityState.Invisible;
                        break;
                    default:
                        throw new ArgumentOutOfRangeException();
                }
