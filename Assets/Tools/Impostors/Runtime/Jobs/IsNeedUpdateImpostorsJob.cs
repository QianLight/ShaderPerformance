...
//                return;
            ...
            var time = gameTime;
            var textureSizeMultiplier = this.textureSizeMultiplier;
            ...
            bool isForcedUpdateRequested = curImpostorableObject.requiredAction ==
                                           ImpostorableObject.RequiredAction.ForcedUpdateImpostorTexture;
            ...
            bool IsNeedUpdate()
            {
                ...
                int resolution = (int) (textureSizeMultiplier * screenSize);
                ...
                curImpostorableObject.textureResolutionCurrent = resolution;
