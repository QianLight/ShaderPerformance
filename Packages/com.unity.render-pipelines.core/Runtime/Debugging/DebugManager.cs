        ...
        public bool displayRuntimeUI
        {
            ...
            set
            {
                if (value)
                {
                    ...
                    string path =
                        "Packages/com.unity.render-pipelines.core/Runtime/Debugging/Prefabs/ResourcesCF/DebugUI Canvas.prefab";
                    #if UNITY_EDITOR
                    m_Root = UnityObject.Instantiate(AssetDatabase.LoadAssetAtPath<Transform>(path)).gameObject;
                    #endif
            ...
            if (m_RootUIPersistentCanvas == null)
            {
                ...
                if (uiManager == null)
                {
                   // m_PersistentRoot = UnityObject.Instantiate(Resources.Load<Transform>("DebugUI Persistent Canvas")).gameObject;
                    string path =
                        "Packages/com.unity.render-pipelines.core/Runtime/Debugging/Prefabs/ResourcesCF/DebugUI Persistent Canvas.prefab";
                    
                    #if UNITY_EDITOR
                    m_PersistentRoot = UnityObject.Instantiate(AssetDatabase.LoadAssetAtPath<Transform>(path)).gameObject;
                    #endif
