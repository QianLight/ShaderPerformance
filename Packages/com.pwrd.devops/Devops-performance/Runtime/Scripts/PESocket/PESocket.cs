...
namespace PENet {
    public class PESocket<T>
        where T : PESession, new() {
        private Socket skt = null;
        public T session = null;
        public int backlog = 10;
        List<T> sessionLst = new List<T>();
        Action connectFailedCallBack = null;
        ...
        /// Launch Client
        /// </summary>
        public void StartAsClient(string ip, int port, Action connectFailed) {
            try {
                connectFailedCallBack = connectFailed;
