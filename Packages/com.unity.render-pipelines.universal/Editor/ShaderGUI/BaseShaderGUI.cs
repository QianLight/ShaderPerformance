...
namespace UnityEditor
{
    public abstract class BaseShaderGUI : ShaderGUI
    {
        ...
        UnityEditor.Rendering.Universal.SavedBool m_SurfaceOptionsFoldout;

        UnityEditor.Rendering.Universal.SavedBool m_SurfaceInputsFoldout;

        UnityEditor.Rendering.Universal.SavedBool m_AdvancedFoldout;
        ...
        public virtual void OnOpenGUI(Material material, MaterialEditor materialEditor)
        {
            ...
            m_SurfaceOptionsFoldout = new UnityEditor.Rendering.Universal.SavedBool($"{m_HeaderStateKey}.SurfaceOptionsFoldout", true);
            m_SurfaceInputsFoldout = new UnityEditor.Rendering.Universal.SavedBool($"{m_HeaderStateKey}.SurfaceInputsFoldout", true);
            m_AdvancedFoldout = new UnityEditor.Rendering.Universal.SavedBool($"{m_HeaderStateKey}.AdvancedFoldout", false);
