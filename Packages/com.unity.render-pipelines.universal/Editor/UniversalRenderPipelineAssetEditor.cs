...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent roleShadowSettingsText = EditorGUIUtility.TrTextContent("Role Shadows");
            public static GUIContent roleFeaturesText = EditorGUIUtility.TrTextContent("Role Features");
            ...
            public static GUIContent defaultMsaaText = EditorGUIUtility.TrTextContent("真机模式AA", "Controls the global anti aliasing settings.");
            //public static GUIContent uiMsaaText = EditorGUIUtility.TrTextContent("MSAA", "Controls the global anti aliasing settings.");
            public static GUIContent m_AntialiasingText = EditorGUIUtility.TrTextContent("Antialiasing", "only use FXAA now.");
            public static GUIContent m_AntialiasingSharpText = EditorGUIUtility.TrTextContent("FXAA Sharp", "only use FXAA now.");
            public static GUIContent m_TemporaAASettingText = EditorGUIUtility.TrTextContent("TAA Setting", "Setting for TAA.");
            public static GUIContent m_SMAAQualityText = EditorGUIUtility.TrTextContent("SMAA Setting", "Setting for SMAA."); 
            ...
            public static GUIContent bloomText = EditorGUIUtility.TrTextContent("Bloom", "Quality of bloom");
            public static GUIContent m_HBAOSettingText = EditorGUIUtility.TrTextContent("HBAO Setting", "Setting for HBAO.");
            ...
            // Role Shadow settings
            public static GUIContent roleShadowScaleText = EditorGUIUtility.TrTextContent("Role Shadow Scale", "");
            public static GUIContent roleShadowmapResolutionText = EditorGUIUtility.TrTextContent("Role Shadow Resolution", "");
            public static GUIContent roleDepthBias = EditorGUIUtility.TrTextContent("Role Depth Bias", "");
            public static GUIContent roleNormalBias = EditorGUIUtility.TrTextContent("Role Normal Bias", "");
            public static GUIContent roleShadowLayerMask = EditorGUIUtility.TrTextContent("Role Shadow Layer Mask", "");
            public static GUIContent roleShadowEnable = EditorGUIUtility.TrTextContent("Role Shadow Enable", "");
            public static GUIContent roleShadowSize = EditorGUIUtility.TrTextContent("Role Shadow Size", "");
            public static GUIContent roleShadowFar = EditorGUIUtility.TrTextContent("Role Shadow Far", "");
            public static GUIContent roleShadowNear = EditorGUIUtility.TrTextContent("Role Shadow Near", "");
            // Role Render Features
            public static GUIContent roleFaceShadow = EditorGUIUtility.TrTextContent("Role Face Shadow", "");
            public static GUIContent roleScreenSpaceRim = EditorGUIUtility.TrTextContent("Role Screen Space Rim", "");
        ...
        SavedBool m_RoleShadowSettingsFoldout;
        SavedBool m_RoleFeatureFoldout;
        ...
        SerializedProperty m_AADebug;
        SerializedProperty m_Antialiasing;
        SerializedProperty m_AntialiasingSharp;
        SerializedProperty m_TemporaAASetting;
        SerializedProperty m_SMAAQuality;
        SerializedProperty m_HBAOSetting;
        SerializedProperty m_RenderScale;
        SerializedProperty m_BloomQuality;
        ...
        SerializedProperty m_RoleShadowScaleProp;
        SerializedProperty m_RoleShadowResolutionProp;
        SerializedProperty m_RoleDepthBiasProp;
        SerializedProperty m_RoleNormalBiasProp;
        SerializedProperty m_RoleShadowLayerMask;
        SerializedProperty m_RoleShadowEnable;
        SerializedProperty m_RoleShadowSize;
        SerializedProperty m_RoleShadowFar;
        SerializedProperty m_RoleShadowNear;
        SerializedProperty m_RoleFaceShadow;
        SerializedProperty m_RoleScreenSpaceRim;
        ...
        UniversalRenderPipelineAsset obj;
        ...
        void OnEnable()
        {
            obj = serializedObject.targetObject as UniversalRenderPipelineAsset;
            ...
            m_RoleShadowSettingsFoldout = new SavedBool($"{target.GetType()}.RoleShadowSettingsFoldout", false);
            m_RoleFeatureFoldout = new SavedBool($"{target.GetType()}.RoleFeatureFoutout", false);
            ...
            m_HDR = serializedObject.FindProperty("m_Supp" +
                                                  "ortsHDR");
            m_AADebug = serializedObject.FindProperty("m_AADebug");
            m_Antialiasing = serializedObject.FindProperty("m_Antialiasing");
            m_AntialiasingSharp = serializedObject.FindProperty("m_AntialiasingSharp");
            m_TemporaAASetting = serializedObject.FindProperty("m_TemporaAASetting");
            m_SMAAQuality = serializedObject.FindProperty("m_SMAAQuality");
            m_HBAOSetting = serializedObject.FindProperty("m_HBAOSetting"); 
            m_RenderScale = serializedObject.FindProperty("m_RenderScale");
            m_BloomQuality = serializedObject.FindProperty("m_BloomQuality"); 
            ...
            m_RoleShadowScaleProp = serializedObject.FindProperty("m_RoleShadowScale");
            m_RoleShadowResolutionProp = serializedObject.FindProperty("m_RoleShadowResolution");
            m_RoleDepthBiasProp = serializedObject.FindProperty("m_RoleDepthBias");
            m_RoleNormalBiasProp = serializedObject.FindProperty("m_RoleNormalBias");
            m_RoleShadowLayerMask = serializedObject.FindProperty("m_RoleShadowLayerMask");
            m_RoleShadowEnable = serializedObject.FindProperty("m_RoleShadowEnable");
            m_RoleShadowSize = serializedObject.FindProperty("m_RoleShadowSize");
            m_RoleShadowFar = serializedObject.FindProperty("m_RoleShadowFar");
            m_RoleShadowNear = serializedObject.FindProperty("m_RoleShadowNear");
            m_RoleFaceShadow = serializedObject.FindProperty("m_RoleFaceShadow");
            m_RoleScreenSpaceRim = serializedObject.FindProperty("m_RoleScreenSpaceRim");
        ...
        void DrawQualitySettings()
        {
            ...
            if (m_QualitySettingsFoldout.value)
            {
                ...
                string tip = "编辑器下默认开启MSAA，需要接近真机效果，请打开“真机模式AA”";
                EditorGUILayout.HelpBox(tip, MessageType.None);
                EditorGUILayout.PropertyField(m_AADebug, Styles.defaultMsaaText);

                EditorGUILayout.PropertyField(m_Antialiasing, Styles.m_AntialiasingText);
                if(m_Antialiasing.enumValueIndex == 1)
                {
                    m_AntialiasingSharp.floatValue = EditorGUILayout.Slider(Styles.m_AntialiasingSharpText, m_AntialiasingSharp.floatValue, 0.1f, 2);
                }
                else if(m_Antialiasing.enumValueIndex == 2)
                {
                    EditorGUILayout.PropertyField(m_TemporaAASetting, Styles.m_TemporaAASettingText);
                }
                else if (m_Antialiasing.enumValueIndex == 3)
                {
                    EditorGUILayout.PropertyField(m_SMAAQuality, Styles.m_SMAAQualityText);
                }
                EditorGUILayout.EndVertical();
                m_BloomQuality.intValue = EditorGUILayout.Popup(Styles.bloomText, m_BloomQuality.intValue, new [] { "Low", "Medium", "High" });
                EditorGUILayout.PropertyField(m_HBAOSetting, Styles.m_HBAOSettingText);
                if (obj.HBAOSetting.Enable)
                {
                    if (!obj.supportsCameraOpaqueTexture)
                    {
                        obj.supportsCameraOpaqueTexture = true;
                        obj.opaqueDownsampling = Downsampling.None;
                    }
                }
                EditorGUI.indentLevel--;
                EditorGUILayout.Space();
        ...
        void DrawShadowSettings()
        {
            ...
            if (m_ShadowSettingsFoldout.value)
            {
                ...
                m_ShadowNormalBiasProp.floatValue = EditorGUILayout.Slider(Styles.shadowNormalBias, m_ShadowNormalBiasProp.floatValue, -1.0f, UniversalRenderPipeline.maxShadowBias);
        ...
        void DrawRoleSettings()
        {
            m_RoleShadowSettingsFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(m_RoleShadowSettingsFoldout.value, Styles.roleShadowSettingsText);
            if (m_RoleShadowSettingsFoldout.value)
            {
                EditorGUI.indentLevel++;
                m_RoleShadowScaleProp.floatValue = Mathf.Max(0.0f, EditorGUILayout.FloatField(Styles.roleShadowScaleText, m_RoleShadowScaleProp.floatValue));
                EditorGUILayout.PropertyField(m_RoleShadowResolutionProp, Styles.roleShadowmapResolutionText);
                m_RoleDepthBiasProp.floatValue = EditorGUILayout.Slider(Styles.roleDepthBias, m_RoleDepthBiasProp.floatValue, 0.0f, UniversalRenderPipeline.maxShadowBias);
                m_RoleNormalBiasProp.floatValue = EditorGUILayout.Slider(Styles.roleNormalBias, m_RoleNormalBiasProp.floatValue, 0.0f, UniversalRenderPipeline.maxShadowBias);
                EditorGUILayout.PropertyField(m_RoleShadowLayerMask, Styles.roleShadowLayerMask);
                EditorGUILayout.PropertyField(m_RoleShadowEnable, Styles.roleShadowEnable);
                EditorGUILayout.PropertyField(m_RoleShadowSize, Styles.roleShadowSize);
                EditorGUILayout.PropertyField(m_RoleShadowFar, Styles.roleShadowFar);
                EditorGUILayout.PropertyField(m_RoleShadowNear, Styles.roleShadowNear);
            ...
            m_RoleFeatureFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(m_RoleFeatureFoldout.value, Styles.roleFeaturesText);
            if (m_RoleFeatureFoldout.value)
            {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(m_RoleFaceShadow, Styles.roleFaceShadow);
                EditorGUILayout.PropertyField(m_RoleScreenSpaceRim, Styles.roleScreenSpaceRim);
                EditorGUI.indentLevel--;
            }
