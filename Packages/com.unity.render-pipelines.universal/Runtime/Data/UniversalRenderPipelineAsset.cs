...
namespace UnityEngine.Rendering.Universal
{
    ...
    public enum FallbackAA
    {
        Disabled = AntialiasingMode.None,
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] bool m_RequireCopyDepth = false;

        public bool RequireCopyDepth
        {
            get => m_RequireCopyDepth;
            set => m_RequireCopyDepth = value;
        }

        // Quality settings
        [SerializeField] bool m_SupportsHDR = true;
        [SerializeField] MsaaQuality m_UiMSAA = MsaaQuality.Disabled;
        [SerializeField] bool m_AADebug = false;
        [SerializeField] AntialiasingMode m_Antialiasing = AntialiasingMode.None;
        [SerializeField] TemporaAASetting m_TemporaAASetting = null;
        [SerializeField] HBAOSetting m_HBAOSetting = null;
        [SerializeField] float m_AntialiasingSharp = 1.2f;
        [SerializeField] AntialiasingQuality m_SMAAQuality = AntialiasingQuality.Medium;
        ...
        //Role Shadows Settings
        [SerializeField] float m_RoleShadowScale = 3.0f;
        [SerializeField] ShadowResolution m_RoleShadowResolution = ShadowResolution._1024;
        [SerializeField] float m_RoleDepthBias = 0.7f;
        [SerializeField] float m_RoleNormalBias = 0.0f;
        [SerializeField] LayerMask m_RoleShadowLayerMask = -1;
        [SerializeField] bool m_RoleShadowEnable = false;
        [SerializeField] float m_RoleShadowSize = 15f;
        [SerializeField] float m_RoleShadowFar = 100f;
        [SerializeField] float m_RoleShadowNear = 0.3f;
        [SerializeField] bool m_RoleFaceShadow = true;
        [SerializeField] bool m_RoleScreenSpaceRim = true;
        ...
        [SerializeField] int m_BloomQuality = 2;
        ...
        public int uiMsaaSampleCount
        {
            get { return (int)m_UiMSAA; }
            set { m_UiMSAA = (MsaaQuality)value; }
        }

        public bool AADebug
        {
            get { return m_AADebug; }
            set { m_AADebug = value; }
        }
        ...
        public TemporaAASetting TemporaAASetting
        {
            get
            {
                return m_TemporaAASetting;
            }
        }

        public HBAOSetting HBAOSetting
        {
            get
            {
                return m_HBAOSetting;
            }
        }

        public float AntialiasingSharp
        {
            get { return m_AntialiasingSharp; }
        }

        public AntialiasingQuality SMAAQuality
        {
            get { return m_SMAAQuality; }
        }
        /// <summary>
       ...
       /// </summary>
        ...
        public ScriptableRendererData[] GetCurrentRendererData()
        {
        ...
        {
            get { return m_RoleShadowScale; }
        }
        public float roleShadowDepthBias
        {
            get { return m_RoleDepthBias; }
        }
        public float roleShadowNormalBias
        {
            get { return m_RoleNormalBias; }
        }
        public ShadowResolution roleShadowResolution
        {
            get { return m_RoleShadowResolution; }
        }
        public LayerMask roleShadowLayerMask
        {
            get { return m_RoleShadowLayerMask; }
        }
        public bool roleShadowEnable
        {
            get { return m_RoleShadowEnable; }
        }
        public float roleShadowSize
        {
            get { return m_RoleShadowSize; }
        }
        public float roleShadowFar
        {
            get { return m_RoleShadowFar; }
        }
        public float roleShadowNear
        {
            get { return m_RoleShadowNear; }
        }

        // Role render feature
        public bool roleFaceShadow => m_RoleFaceShadow;
        public bool roleScreenSpaceRim 
        {
            get => m_RoleScreenSpaceRim; 
            set => m_RoleScreenSpaceRim = value;//Change by: Takeshi
        }
...
#endif
        public UnityEngine.Rendering.Universal.ScriptableRendererFeature SetFeature(string featureName, bool open)
        {
            UnityEngine.Rendering.Universal.ScriptableRendererFeature feature = null;
            UnityEngine.Rendering.Universal.ScriptableRendererData[] data = m_RendererDataList;
            if (data.Length > 0)
            {
                UnityEngine.Rendering.Universal.ScriptableRendererData RendererData = data[0];
                foreach (UnityEngine.Rendering.Universal.ScriptableRendererFeature tmp in RendererData.rendererFeatures)
                {
                    if (tmp.name == featureName)
                    {
                        feature = tmp;
                        tmp.SetActive(open);
                        break;
...
#pragma warning restore 618 // Obsolete warning
        ...
        {
            return Mathf.Max(-1.0f, Mathf.Min(value, UniversalRenderPipeline.maxShadowBias));
        }
