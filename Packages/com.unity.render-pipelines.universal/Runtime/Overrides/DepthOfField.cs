...
namespace UnityEngine.Rendering.Universal
{
    ...
    #region OldMode
        public BoolParameter easyMode = new BoolParameter(true);
        public FloatParameter focusDist = new FloatParameter(30);
        public FloatParameter bokehRangeNear = new FloatParameter(1);
        public FloatParameter focusRangeFar = new FloatParameter(0);
    #endregion
