...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class ColorGradingLutPass : ScriptableRenderPass
    {
        ...
        private RenderTexture targetRT = null;
        /// <inheritdoc/>
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.ColorGradingLUT)))
            {
                ...
                if(targetRT == null)
                {
                    ...
                    targetRT.name = "FastLUT";
                    Shader.SetGlobalTexture(ShaderConstants._InternalLut, targetRT);
                }
                ...
                if (hdr)
                {
                    ...
                    switch (tonemapping.mode.value)
                    {
                        ...
                        case TonemappingMode.Custom:
                             ...
                             UnityCustomTonemapping(tonemapping, material);
                             break;
                        default: break; // None
                    }
                }
                ...
                Blit(cmd, targetRT, targetRT, material);
        ...
        public void Cleanup()
        {
            ...
            if(targetRT != null)
            {
                GameObject.DestroyImmediate(targetRT);
                targetRT = null;
            }
        }
