    ...
    internal class Renderer2D : ScriptableRenderer
    {
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            bool requireFinalPostProcessPass =
                lastCameraInStack && !ppcUpscaleRT && stackHasPostProcess && UniversalRenderPipeline.asset.Antialiasing != AntialiasingMode.None;
            ...
            if (cameraData.postProcessEnabled)
            {
                ...
                bool useTAA = UniversalRenderPipeline.asset.Antialiasing == AntialiasingMode.TAA;
                if(useTAA)
            ...
            if (requireFinalPostProcessPass)
            {
                if (GameQualitySetting.ToneMapping)
                {
                    m_FinalPostProcessPass.SetupFinalPass(m_TemporaPass, cameraTargetDescriptor, colorTargetHandle);
