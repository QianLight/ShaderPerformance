...
namespace UnityEngine.Rendering.Universal
{
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public struct CameraData
    {
        ...
        public Transform waterLightDir;

        //Role Shadow
        public float roleShadowScale;
        public ShadowResolution roleShadowResolution;
        public float roleDepthBias;
        public float roleNormalBias;
        public LayerMask roleShadowLayerMask;
        public bool roleShadowEnable;
        public float roleShadowSize;
        public float roleShadowFar;
        public float roleShadowNear;
    }
    ...
    internal static class ShaderPropertyId
    {
        ...
        public static readonly int noise3DTex = Shader.PropertyToID("_Noise3DTex");
        public static readonly int fogStartParams = Shader.PropertyToID("_FogStartParams");
        public static readonly int fogEndParams = Shader.PropertyToID("_FogEndParams");
        public static readonly int fogIntensityMin = Shader.PropertyToID("_FogIntensityMin");
        public static readonly int fogIntensityMax = Shader.PropertyToID("_FogIntensityMax");
        public static readonly int fogIntensityScale = Shader.PropertyToID("_FogIntensityScale");
        public static readonly int fogFalloffParams = Shader.PropertyToID("_FogFalloffParams");
        public static readonly int fogNoiseScaleOffset = Shader.PropertyToID("_FogNoiseScaleOffset");
        public static readonly int fogStartColor = Shader.PropertyToID("_FogStartColor");
        public static readonly int fogEndColor = Shader.PropertyToID("_FogEndColor");
        public static readonly int fogBottomColor = Shader.PropertyToID("_FogBottomColor");
        public static readonly int fogTopColor = Shader.PropertyToID("_FogTopColor");
        public static readonly int fogShaftOffset = Shader.PropertyToID("_FogShaftOffset");
        public static readonly int fogMiscParams = Shader.PropertyToID("_FogMiscParams");
        public static readonly int fogScatterColor = Shader.PropertyToID("_FogScatterColor");
        public static readonly int globalFog = Shader.PropertyToID("_GlobalFog");
        ...
        public static readonly int cameraBackward = Shader.PropertyToID("_CameraBackward");
        ...
        public static readonly int outlineScale = Shader.PropertyToID("_OutlineScale");
        public static readonly int roleRamp = Shader.PropertyToID("_RoleRamp");
        public static readonly int rimParam = Shader.PropertyToID("_RimParam");
        public static readonly int lightFadePram = Shader.PropertyToID("_LightFadePram");
        public static readonly int isInUICamera = Shader.PropertyToID("_IsInUICamera");/* By:Takeshi Apply:矫正UI透明度 */
    }
    ...
    public static class LayerMaskName
    {
        ...
        public static readonly int UIScene = 8;
    }
    public static class ShaderKeywordStrings
    {
        ...
        public static readonly string DepthMsaa4 = "_DEPTH_MSAA_4";        public static readonly string DepthMsaa8 = "_DEPTH_MSAA_8";

        public static readonly string LinearToSRGBConversion = "_LINEAR_TO_SRGB_CONVERSION";
        public static readonly string SRGBToLinearConversion = "_SRGB_TO_LINEAR_CONVERSION";/* By:Takeshi Apply:矫正UI透明度Gamma的分支 */
        public static readonly string IsNotInUICamera = "_IS_NOT_IN_UI_CAMERA";/* By:Takeshi Apply:不矫正UI透明度Gamma的UIshader分支 */
        ...
        public static readonly string BloomModeMinus = "_BLOOM_MODE_MINUS";
        public static readonly string BloomModeLegacy = "_BLOOM_MODE_LEGACY";
        public static readonly string GodRay = "_GODRAY";
        public static readonly string GodRayUseNoise = "_GODRAY_USE_NOISE";
        ...
        public static readonly string TonemapCustom = "_TONEMAP_CUSTOM";
        public static readonly string FilmGrain = "_FILM_GRAIN";
        public static readonly string Hbao = "_HBAO";
        public static readonly string Fxaa = "_FXAA";
        public static readonly string FxaaLuminance = "_FXAA_LUMINANCE";
        public static readonly string Taa = "_TAA";
        public static readonly string MixAA= "_MIX_AA";
        ...
        public static readonly string RadialBlur = "_RADIAL_BLUR";
        public static readonly string CustomDistortion = "_CUSTOM_DISTORTION";
    ...
    public sealed partial class UniversalRenderPipeline
    {
        ...
        static UniversalRenderPipelineAsset _asset;
            ...
            bool isHdrEnabled, int msaaSamples, bool needsAlpha, bool requiresOpaqueTexture)
        {
            ...
            if(!RenderingUtils.SupportsGraphicsFormat(renderTextureFormatDefault, FormatUsage.Linear | FormatUsage.Render))
            {
                renderTextureFormatDefault = GraphicsFormatUtility.GetGraphicsFormat(RenderTextureFormat.ARGB32, true);
                if (!RenderingUtils.SupportsGraphicsFormat(renderTextureFormatDefault, FormatUsage.Linear | FormatUsage.Render))
                {
                    renderTextureFormatDefault = GraphicsFormat.R8G8B8A8_UNorm;
                }
            }
    ...
    internal enum URPProfileId
    {
        ...
        // DrawObjectsPass
        DrawOpaqueObjects,
        DrawFaceShadowCasters,
        DrawFaceShadows,
        DrawScreenSpaceRimPass,
        DrawPlanarShadows,
        DrawOutlines,
        PreZ,
        DrawTransparentObjects,
        DrawGPUInstancingPreZ,
        DecalPass,
        GrassRenderPass,
        DrawGPUInstancingColor,
        RoleEffects,
