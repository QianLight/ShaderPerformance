...
namespace UnityEngine.Rendering.Universal
{
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public class UniversalAdditionalCameraData : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] bool m_IsUiCamera = false;
        [SerializeField] bool m_IsMainCamera = false;
        [SerializeField] bool m_IsUiSceneCamera = false;
        [SerializeField] bool m_GameTypeInit = true;
        [SerializeField] Transform m_WaterLightDir;
        ...
        void gameTypeInit()
        {
            if (m_GameTypeInit)
            {
                if (camera != null)
                {
                    ...
                    m_IsUiCamera = obj.layer == LayerMaskName.UI;
                    m_IsUiSceneCamera = obj.layer == LayerMaskName.UIScene; 
                    m_IsMainCamera = obj.CompareTag("MainCamera");
                    m_GameTypeInit = false; 
                }
            }
        }
