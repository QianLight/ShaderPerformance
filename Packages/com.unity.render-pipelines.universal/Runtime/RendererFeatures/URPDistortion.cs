...
// }
[ExcludeFromPreset]
public class URPDistortion : ScriptableRendererFeature
{
    [System.Serializable]
    public class URPDistortionSettings
    {
        public string passTag = "URPDistortionFeature";
    ...
    public URPDistortionSettings settings = new URPDistortionSettings();

    URPDistortionPass renderObjectsPass;
...
//Keyword
        if (isActive)
        {
            Shader.EnableKeyword("_CUSTOM_DISTORTION");
        }
        else
        {
        ...
        renderObjectsPass = new URPDistortionPass(
            settings.Event, 
            filter.PassNames,
