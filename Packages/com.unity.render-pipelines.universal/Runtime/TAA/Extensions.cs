...
namespace UnityEngine.Rendering.Universal
{
    public static class Vector2Extension
    {
        ...
        public static void EnsureKeyword(this Material material, string name, bool enabled)
        {
    ...
    public static class CameraExtension
    {
        ...
        public static Matrix4x4 GetProjectionMatrix(this Camera camera, out Vector4 extents)
        {
            return GetProjectionMatrix(camera, 0.0f, 0.0f, out extents);
        }

        public static Matrix4x4 GetProjectionMatrix(this Camera camera, float texelOffsetX, float texelOffsetY, out Vector4 extents)
        {
            if (camera == null)
            {
            ...
            extents = GetProjectionExtents(camera, texelOffsetX, texelOffsetY);
