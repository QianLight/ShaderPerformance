...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract partial class ScriptableRenderer : IDisposable
    {
        ...
        public static void SetCameraMatrices(CommandBuffer cmd, ref CameraData cameraData, bool setInverseMatrices)
        {
            ...
            Vector3 cameraBackward = viewMatrix.inverse.MultiplyVector(Vector3.back);
            ...
            if (setInverseMatrices)
            {
                ...
                cmd.SetGlobalVector(ShaderPropertyId.cameraBackward, cameraBackward);
        ...
        void SetPerCameraShaderVariables(CommandBuffer cmd, ref CameraData cameraData)
        {
            ...
            cmd.SetGlobalFloat(ShaderPropertyId.cameraFOV,camera.fieldOfView);

            if (GameQualitySetting.ToneMapping)
            {
                cmd.SetGlobalFloat(ShaderPropertyId.isInUICamera, cameraData.isUiCamera ? 1 : 0);
            }
            else
            {
        ...
        public void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (cameraData.camera.cameraType == CameraType.Game && EngineContext.IsRunning && EngineContext.instance != null)
            {
                renderingData.renderLayerMask = EngineContext.instance.layerMask;
            }

            CommandBuffer cmd = CommandBufferPool.Get();
            
            // #if UNITY_EDITOR
            // if (cameraData.isSceneViewCamera)/*By:Takeshi; Fix UI Color Gamma in scene view */
            // {
            //     cmd.EnableShaderKeyword(ShaderKeywordStrings.UIGammaFixInSceneView);
            // }
            // #endif
            ...
            // if (cameraData.isSceneViewCamera)/*By:Takeshi; Fix UI Color Gamma in scene view */
            // {
            //     cmd.DisableShaderKeyword(ShaderKeywordStrings.UIGammaFixInSceneView);
            // }
            // #endif
        ...
        protected static ClearFlag GetCameraClearFlag(ref CameraData cameraData)
        {
            ...
            // >>>>>>>>>>>>>>>>>>>>
            // 2021年11月22日 张新颖：
            // 在Editor为了解决Overdraw预览问题，这里需要一直都是All。
        ...
        void ExecuteRenderPass(ScriptableRenderContext context, ScriptableRenderPass renderPass, ref RenderingData renderingData)
        {
            ...
            if (cameraData.isUiCamera)
            {
                renderingData.renderLayerMask = 4294967295;
            }
