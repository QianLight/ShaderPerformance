...
//#define _MainLightPosition _MainLightDir0
float4 _MainLightPosition;

half4 _MainLightColor0;

//--为了保证模型的preview 界面显示正确，先把 _MainLightColor 和 _MainLightColor0 一起赋值，
//--_MainLightColor在URP内置管线赋值
//--_MainLightColor0在自定义的Lighting类里赋值
