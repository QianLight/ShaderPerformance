...
//------------- 大世界环境反射球融合 ---------------------
TEXTURECUBE(_ExplorationCurSpecCube);
SAMPLER(sampler_ExplorationCurSpecCube);
TEXTURECUBE(_ExplorationTargetSpecCube);
SAMPLER(sampler_ExplorationTargetSpecCube);

real4 _ExplorationCurSpecCube_HDR;
real4 _ExplorationTargetSpecCube_HDR;

real4 _ExplorationParams;
//----------------------------------------
