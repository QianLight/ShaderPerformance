...
namespace UnityEngine.AssetGraph {
	...
	public class AssetBundleBuildReport {
...
#if ZEUS_ASSET_ENABLE_SBP
		private CompatibilityAssetBundleManifest  m_manifest;
#elif ENABLE_UNITY_CUSTOM_ASSETBUNDLE_BUILD
		private DistributedBuild.AssetBundleManifest m_manifest;
#else
...
#elif ENABLE_UNITY_CUSTOM_ASSETBUNDLE_BUILD
		public DistributedBuild.AssetBundleManifest Manifest {
#else
		...
		public AssetBundleBuildReport(
			Model.NodeData node,
#if ZEUS_ASSET_ENABLE_SBP
			CompatibilityAssetBundleManifest m,
#elif ENABLE_UNITY_CUSTOM_ASSETBUNDLE_BUILD
			DistributedBuild.AssetBundleManifest m,
#else
