		...
		public static void BuildFromCommandline(){
			...
			try {
				...
				if(graphIndex >= 0 && collectionIndex >= 0) {
					...
					throw new AssetGraphException("-graph and -collection can not be used at once. Aborting...");
				}
				...
				if(graphIndex >= 0) {
					...
					if (graph == null) {
						...
						throw new AssetGraphException("Graph data not found. To specify graph to execute, use -graph [path]. Aborting...");
					}
					...
					if(result.IsAnyIssueFound) {
						...
						throw new AssetGraphException("Building asset bundles terminated because of following errors. Please fix issues by opening editor.");
					}
				}
				...
				if(collectionIndex >= 0) {
					...
					if (collectionName == null) {
						...
						throw new AssetGraphException("Collection name not specified. To specify collection to execute, use -collection [name]. Aborting...");
					}
					...
					if (c == null) {
						...
						throw new AssetGraphException("Collection not found. Please open project and configure graph collection. Aborting...");
					}
